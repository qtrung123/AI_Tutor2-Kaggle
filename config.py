...
QUIZ_GENERATION_CONCEPT_BATCH_SIZE = int(os.getenv("QUIZ_GENERATION_CONCEPT_BATCH_SIZE", "4"))
QUIZ_VALIDATION_BATCH_SIZE = int(os.getenv("QUIZ_VALIDATION_BATCH_SIZE", "4"))
