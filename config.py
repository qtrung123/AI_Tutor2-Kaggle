...
GENERATION_MODELS = tuple(dict.fromkeys(
    model.strip() for model in os.getenv("OLLAMA_GENERATION_MODELS", "qwen-2.5-7b,qwen3-8b").split(",") if model.strip()
)) or ("qwen-2.5-7b", "qwen3-8b")
DEFAULT_GENERATION_MODEL = os.getenv("OLLAMA_DEFAULT_GENERATION_MODEL", "qwen-2.5-7b")
QUIZ_DEFAULT_GENERATION_MODEL = os.getenv("OLLAMA_QUIZ_DEFAULT_GENERATION_MODEL", "qwen3-8b")
